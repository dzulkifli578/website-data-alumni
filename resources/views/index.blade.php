            ...
            <div class="flex flex-wrap gap-4 justify-center">
                ...
                <div onclick="window.location.href='{{ route('rpl') }}'"
                    ...
                    <div class="flex-grow">
                        ...
                        <p class="group-hover:text-black font-bold text-lg">{{ $jumlahAlumni }}</p>
                    </div>
                </div>
                <!-- Statistik Item -->
                <div
                    ...
                    <div class="flex-grow">
                        <p class="group-hover:text-black font-bold text-start">Alumni Terbanyak
                            ({{ $AlumniTerbanyakTahun->tahun_lulus }})</p>
                        <p class="group-hover:text-black font-bold text-lg">{{ $AlumniTerbanyakTahun->jumlah }}</p>
                    </div>
                </div>
                <!-- Statistik Item -->
                <div
                    ...
                    <div class="flex-grow">
                        <p class="group-hover:text-black font-bold text-start">Alumni Terbanyak
                            ({{ $AlumniTerbanyakJurusan->jurusan }})</p>
                        <p class="group-hover:text-black font-bold text-lg">{{ $AlumniTerbanyakJurusan->jumlah }}</p>
                    </div>
                </div>
            </div>
        </div>
