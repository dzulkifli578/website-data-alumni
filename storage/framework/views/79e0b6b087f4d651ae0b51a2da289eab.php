            ...
            <section class="space-y-6">
                ...
                <div class="flex flex-wrap gap-6 mb-6">
                    ...
                    <div class="bg-base-300 p-4 rounded shadow flex items-center space-x-4">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold">Alumni Terbanyak (<?php echo e($alumniTerbanyakTahun->tahun_lulus); ?>)</h3>
                    ...
                    <div class="bg-base-300 p-4 rounded shadow flex items-center space-x-4">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold">Alumni Tersedikit (<?php echo e($alumniTersedikitTahun->tahun_lulus); ?>)</h3>
                    ...
                    <div class="bg-base-300 p-4 rounded shadow flex items-center space-x-4">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold">Alumni Terbanyak (<?php echo e($alumniTerbanyakJurusan->jurusan); ?>)</h3>
                    ...
                    <div class="bg-base-300 p-4 rounded shadow flex items-center space-x-4">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold">Alumni Tersedikit (<?php echo e($alumniTersedikitJurusan->jurusan); ?>)</h3>
...
<?php /**PATH D:\Dzulkifli\Laravel\website-data-alumni\resources\views/akun/chart.blade.php ENDPATH**/ ?>