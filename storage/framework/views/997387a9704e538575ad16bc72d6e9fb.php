    ...
    <nav class="navbar bg-base-100 py-0 mb-4 border-b border-base-content">
        <div class="container mx-auto flex justify-between items-center px-4">
            ...
            <div class="navbar-start flex flex-row items-center">
                <img src="<?php echo e(asset('img/swadhipa.png')); ?>" alt="Swadhipa" class="w-auto h-10">
                <button onclick="window.location.href='<?php echo e(route('index')); ?>'"
...
<?php /**PATH D:\Dzulkifli\Laravel\website-data-alumni\resources\views/navbar.blade.php ENDPATH**/ ?>