<label class="grid cursor-pointer place-items-center">
    <input type="checkbox" class="toggle theme-controller bg-base-content col-span-2 col-start-1 row-start-1" id="theme-switch" onchange="toggleTheme()" />
...
<script>
    ...
    window.addEventListener('DOMContentLoaded', () => {
        const storedTheme = localStorage.getItem('theme') || 'light'; // default ke 'light' jika belum ada
        const themeSwitch = document.getElementById('theme-switch');
        document.documentElement.setAttribute('data-theme', storedTheme);
        themeSwitch.checked = storedTheme === 'dark';
    });
</script>
<?php /**PATH D:\Dzulkifli\Laravel\website-data-alumni\resources\views/switch-theme.blade.php ENDPATH**/ ?>